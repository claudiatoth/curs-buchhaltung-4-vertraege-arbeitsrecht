// ============================================
// PDF BUILDER — Buchhaltung Teil 4: Verträge & Arbeitsrecht (B1)
...
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Verträge & Arbeitsrecht (Grundwortschatz)</h1>` + t;
    }
    ...
    function buildDialog() {
        ...
        dialog1Data.replici.forEach(r => {
            const sp = r.speaker === 'andreea' ? 'Andreea 🇷🇴' : 'Herr Berger 👔';
    ...
    function buildFlashcards() {
        let html = `<h1 class="chapter new-section">📇 4. Vocabular complet (Flashcards)</h1>
            <p style="margin-bottom:14px">Cele <strong>${typeof flashcardsData !== 'undefined' ? flashcardsData.length : 0} de carduri</strong> ale lecției — vocabularul contractelor și al dreptului muncii.</p>
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 5. Verb-Konjugation — verbe contracte/muncă</h1>
            <div class="theory-box warn-box"><p><strong>📌 Reamintire:</strong> Neseparabile (unterschreiben, beantragen, verlängern) → Perfekt FĂRĂ „ge-". Separabile (einstellen) → „-ge-" la mijloc. kündigen e regulat și cere persoana la DATIV. Präteritum = IMPERFECT.</p></div>`;
